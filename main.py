...
if __name__ == "__main__":
    ...
    PRM_planner.sample(n_pts=1000, sampling_method="random", kdtree_d=18)
    PRM_planner.search(start, goal)
    PRM_planner.sample(n_pts=2000, sampling_method="gaussian", kdtree_d=20)
    PRM_planner.search(start, goal, kdtree_d=100)
    PRM_planner.sample(n_pts=20000, sampling_method="bridge", kdtree_d=20)
    PRM_planner.search(start, goal, kdtree_d=100)

    # Search with RRT and RRT*
    RRT_planner.RRT(n_pts=1000)
    RRT_planner.RRT_star(n_pts=1500)
